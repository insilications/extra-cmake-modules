...
Version  : 5.50.0
Release  : 8
URL      : https://github.com/KDE/extra-cmake-modules/archive/v5.50.0.tar.gz
Source0  : https://github.com/KDE/extra-cmake-modules/archive/v5.50.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1536416140
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
