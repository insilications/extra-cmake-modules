...
Source0  : https://download.kde.org/stable/frameworks/5.58/extra-cmake-modules-5.58.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.58/extra-cmake-modules-5.58.0.tar.xz.sig
...
%prep
%setup -q -n extra-cmake-modules-5.58.0
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1557763317
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
